      ...
      <div className="w-full md:w-96 md:max-w-full mx-auto bg-indigo-300 rounded-lg shadow-lg">
        <div className="p-6 border border-gray-300 sm:rounded-md">
          <label className="block mb-6">
            <span className="text-gray-700 text-xl font-bold mb-15">
              {t('subscribe')}
            </span>
            <input
              className="block px-2 py-2 w-full mt-15 border-gray-500 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
